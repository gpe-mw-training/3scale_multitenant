...
This workload provisions a single centralized 3scale API Manager in a single OCP namespace called: 3scale-mt-{{ocp_amp_admin_prefix}}.
...
$ echo "export ocp_amp_admin_prefix=amp0" >> ~/.bashrc
...
The OCP namespace for 3scale multi-tenant app will be owned by the following user: {{ocp_amp_admin_prefix}}.

{{ocp_amp_admin_prefix}} will be assigned a clusterquota so as to manage limits and requests assigned to 3scale
...
$ ansible-playbook -i localhost, -c local /tmp/3scale_multitenant.yml \
                    ...
                    -e"ocp_amp_admin_prefix=$ocp_amp_admin_prefix" \
...
ok: [localhost] => {
    "msg": [
        "tenant_output_dir:  /home/jbride/provisioning_output/3295.openshift.opentlc.com/3scale_tenants_amp0",
        "tenant_provisioning_log_file = /home/jbride/provisioning_output/3295.openshift.opentlc.com/3scale_tenants_amp0/amp0_tenant_provisioning.log",
        "tenant_provisioning_results_file = /home/jbride/provisioning_output/3295.openshift.opentlc.com/3scale_tenants_amp0/amp0_tenant_info_file_1_2.txt",
